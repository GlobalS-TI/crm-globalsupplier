...
export function ITTicketAssignedEmail({ ticketTitle, requesterName, ticketUrl }: Props) {
  return (
    <Html lang="es">
      <Head />
        ...
        <Container style={{ maxWidth: '540px', background: '#fff', borderRadius: '8px', border: '1px solid #e5e7eb', overflow: 'hidden' }}>
          ...
          <Section style={{ padding: '28px 24px' }}>
            ...
            <Text style={{ margin: '0 0 20px', color: '#374151' }}>
              <strong>{requesterName}</strong> levantó un nuevo ticket: <strong>"{ticketTitle}"</strong>.
            </Text>
            <Button
              href={ticketUrl}
